...
public class ShootGame extends JPanel {
	...
	static{
		...
		try {
			...
			bigplane = ImageIO.read(new File("bigplane.png"));
			...
			hero1 = ImageIO.read(new File("hero1.png"));
	...
	public void action(){
		...
		}, 10,10); //界面每隔10亳秒变化一次 ，第一个10程序启动到第一次触动定时器任务的时间间隔  第二个10第一次触发定时器到第二次触发的时间间隔
	...
	public void nextOne(){
		...
		//将新敌人放入数组末尾
		flyers[flyers.length - 1] = (Flyer) f;
	}
